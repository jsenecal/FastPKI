...
@pytest.mark.asyncio
async def test_organization_service_get_by_id(
    db: AsyncSession, direct_test_org: Organization
):
...
@pytest.mark.asyncio
async def test_organization_service_get_by_name(
    db: AsyncSession, direct_test_org: Organization
):
...
@pytest.mark.asyncio
async def test_organization_service_get_all(
    db: AsyncSession, direct_test_org: Organization
):
...
@pytest.mark.asyncio
async def test_organization_service_update(
    db: AsyncSession, direct_test_org: Organization
):
...
@pytest.mark.asyncio
async def test_organization_service_add_user(
    db: AsyncSession, direct_test_org: Organization, direct_normal_user: User
):
...
@pytest.mark.asyncio
async def test_organization_service_remove_user(
    db: AsyncSession, direct_test_org: Organization, direct_user_in_org: User
):
...
@pytest.mark.asyncio
async def test_organization_service_get_users(
    db: AsyncSession, direct_test_org: Organization, direct_user_in_org: User
):
...
@pytest.mark.asyncio
async def test_organization_service_user_count(
    db: AsyncSession, direct_test_org: Organization, direct_user_in_org: User
):
...
@pytest.mark.asyncio
async def test_organization_service_has_access(
    db: AsyncSession, direct_test_org: Organization, direct_user_in_org: User
):
...
@pytest.mark.asyncio
async def test_organization_service_superuser_has_access(
    db: AsyncSession, direct_test_org: Organization, direct_superuser: User
):
...
@pytest.mark.asyncio
async def test_organization_service_has_admin_access(
    db: AsyncSession, direct_test_org: Organization, direct_admin_user: User
):
